...
****************************************************************************/
/**************************************************************************
* -Luis: Modified buffer and TWI_TWBR to match clock used and Device specs*
***************************************************************************/
 
#define TWI_BUFFER_SIZE 22   // Set this to the largest message size that will be sent including address byte.
